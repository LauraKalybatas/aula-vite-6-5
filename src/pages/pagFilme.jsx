      ...
      <main className="bg-neutral-900">
        <div className="absolute z-20 flex">
          <div className="pl-11 pt-8">
            <img
              className="rounded-lg w-[339px] h-[550px]  "
              src={`${urlImg}${filmes.poster_path}`}
            ></img>
          </div>
        </div>
        ...
        <div className="absolute z-20 mt-[100px] flex flex-col ml-[450px]">
          <div className="">
            ...
            <div className="flex">
              <p className="text-white text-[18px] pr-[10px]">
                {filmes.release_date}
              </p>
              <span className="text-white text-bold pr-[10px]">–</span>
              <p className="text-white text-[18px] pr-[10px]">
                {filmes.origin_country}
              </p>
              <span className="text-white text-bold pr-[10px]">–</span>
            ...
            <p className="text-white text-[22px] font-semibold mt-[50px]  ">
              Sinopse
            </p>
        ...
        <div
          className="w-full h-[623px] bg-cover"
          style={{ backgroundImage: `url(${urlImg}${filmes.backdrop_path})` }}
        >
          <div className=" bg-black w-full h-full opacity-70"></div>
        </div>

        <p className="text-white text-[30px] font-bold ml-[55px] mt-[45px]">
          Recomendações
        </p>
        <Recomendacao />
      </main>
